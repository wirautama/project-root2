    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form action="<?= base_url('/resetPassword'); ?>" method="POST">
                ...
                <div class="form-group <?= (validation_show_error('reset_token')) ? 'has-error' : 'has-feedback'; ?>">
                    <?= (validation_show_error('reset_token')) ? '<label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> Token
                    </label>' : ''; ?>
                    <input type="text" id="inputError" name="reset_token" class="form-control" placeholder="token">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                    <span class="help-block">
                ...
                <div class="form-group <?= (validation_show_error('retype_password')) ? 'has-error' : 'has-feedback'; ?>">
                    ...
                    <input type="password" id="inputError" name="retype_password" class="form-control" placeholder="Retype password">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                    <span class="help-block">
